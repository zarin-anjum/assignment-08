...
const AllApps = () => {
  ...
  return (
    <div className="text-center p-10 md:p-14 lg:p-20 bg-gray-100">
      <h1 className="font-bold text-2xl md:text-3xl lg:text-5xl mb-4">Our All Applications</h1>
      ...
      {filteredApps.length > 0 ?(
        ...
        <p className="text-center font-bold text-gray-700 text-lg mt-10">No App Found</p>
      )}
    </div>
  );
};
